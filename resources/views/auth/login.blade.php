                ...
                <div class="border">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <fieldset class="text-center p-4">
                            ...
                            <button type="submit" class="py-3 px-5 bg-primary text-white border-0 rounded font-weight-bold mt-3">Log in</button>
                            <a class="mt-3 d-block text-primary" href="{{ route('register') }}">Register Now</a>
                        </fieldset>
                    </form>
                </div>
            </div>
